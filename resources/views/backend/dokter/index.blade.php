            ...
            <div class="card text-center">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach ($dokter as $pk)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $pk->nama_dokter }}</td>
                                <td>{{ $pk->spesialis }}</td>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('dokter.destroy', $pk->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form id="edit_pengalaman_kerja_form" method="POST"
                                            action="{{ route('dokter.update', $pk->id) }}">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="nama_dokter" id="nama_dokter"
                                                        value="{{ $pk->nama_dokter }}" required>
                                                </div>

                                                <div class="form-group mb-3">
                                                    <label for="spesialis">Spesialis</label>
                                                    <input type="text" class="form-control" name="spesialis" id="spesialis"
                                                        value="{{ $pk->spesialis }}" required>
                                                </div>
...
<script>
    ...
    $("form[name='pengalaman_kerja_form']").validate({
        ...
        messages: {
            nama: "Mohon isi nama dokter",
            jabatan: "Mohon isi spesialis",
            tahun_masuk: {
